...
if(ceckAjax('l')){
    ...
    foreach($fileds as $key){
           ...
           if($key == 'item'){
               ...
               $html .= '<div style="position: relative" ><select style="width:100px; margin-bottom: 20px" id="order_'.$id.'" name="order_id[]" class="drop select check_drop_changes validate[required]">';
               ...
               $html .= '<div style="position: relative; height:50px" ><input autocomplete="off" style="width:55px" class="check_quantity validate[required, custom[onlyNumber]]" value="" id="'.$id.'_'.$price.'" name="'.$key.'[]" ></div>';
