...
<div id="wrapper">
    ...
    <div id="nav">
        <ul>
            ...
            <li><a href="grid.html"></a><span class="icon">S</span>Customer</li>
    ...
    <div id="content" class="ui-page"><!--BEGIN MAIN CONTENT-->
        ...
        <div class="cont full ui-sortable" id="sort-boxes">
            ...
            <div id="work_area" class="box g16">
                <h2 class="box-ttl">Work Area <span class="box-desc">I Can stay with you :)</span></h2>
            ...
            <div id="smp-form" class="box g8 invoice_form hidden-desktop">
                <p class="box-ttl">Add New Invoice</p>
                <div class="box-body">
                    ...
                    <form id="new-invoice-form">
                        ...
                        <div id="t_invoice">
                            ...
                            <div class="g6 row6" id="total_bill"></div>
                        ...
                        <button type="submit" disabled="" id="save_customized" class="purple btn-m flt-r g3 customized">Save Customized</button>
            ...
            <div id="smp-form" class="box g8 order_form hidden-desktop">
                <p class="box-ttl">New Order</p>
                <div class="box-body">

                    <form id="new-order-form">

                        <div id="box_customer_name" class="g16">
                            <input type="text" name="lot_no" placeholder="LOT#" class="required g3">
                            <input type="text" name="container_no" placeholder="Container number" class="required g5">
                            <input type="text" name="expenses" placeholder="Expenses of the container" class="required g5">
                            <input type="text" name="po" placeholder="P.O" class="required g2">
                        </div>

                        <div id="box_customer_name" class="g16">
                            <input type="text" name="supplier" placeholder="Supplier" class="required g5">
                            <input type="text" name="shipping_company" placeholder="Shipping Company" class="required g5">
                            <input type="text" name="shipping_expenses" placeholder="Shipping Expenses" class="required g5">
                        </div>
