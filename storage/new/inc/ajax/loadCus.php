...
if(ceckAjax('l')){
	...
	inv.c_id='$c_id'";
        ...
        <div class="box g4 row6 customer_row" style="text-align: center" id="customer_<?=$r['id']?>">
            <div class="box-ttl row6" ><span id="customer_company_name"><?=$r['company']?></span><br><br><br>
                <!--<span class="tag orange inline"><?=Price($total)?></span>--><span class="tag green inline"><?=$lastInvice?></span></div>
        </div>
    <?
    }
}
