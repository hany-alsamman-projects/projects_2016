...
if($rows>0){
	...
	if($rows2>0){?>
    <table border="0" cellpadding="5" cellspacing="1" class="inv_list " >
    <tr><th width="100">Iteme</th><th width="100">Price</th><th width="100">Quantity</th><th width="100">Balance</th></tr><?
	$i=0;	
	$total=0;
	while($i<$rows2){
