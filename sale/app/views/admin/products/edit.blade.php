            ...
            <div class="widget widget-simple">
                ...
                <div class="widget-content">
                    <div class="widget-body">
                        <form id="accounForm" class="form-horizontal" method="post"  enctype="multipart/form-data"  action="{{URL::to("admin/product/edit/$product->id")}}">
                            <div class="row-fluid">
                                <div class="span14 form-dark">
                                    <fieldset>
                                        <legend>Edit News Information
                                        </legend>
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="accountPrefix" class="span6" type="text" value="{{$product->title}}" name="title">
                                                </div>
                                            </li>
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="accountPrefix" class="span6" type="text" value="{{$product->subject}}" name="subject">
                                                </div>
                                            </li>
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                        {{ Form::select('dept_id', $depts, $product->dept_id, array('class' => 'span6')) }}
                                                </div>
                                            </li>
