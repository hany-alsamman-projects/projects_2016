<div class="row-fluid page-head">
    <h2 class="page-title"><i class="fontello-icon-folder-2"></i> Products <small>Management</small></h2>
    <!--<p class="pagedesc">page desc here </p> -->
    <div class="page-bar">
        <div class="btn-toolbar">
            <ul class="nav nav-tabs pull-right">
                <li class="active" id="demo1-tab"> <a href="#TabTop1" data-toggle="tab">Show Products</a> </li>
                @if(Sentry::getUser()->isSuperUser())
                <li id="demo2-tab"> <a href="#TabTop2" data-toggle="tab">Add Product</a> </li>
                @endif
            </ul>
        </div>
    </div>
    ...
    <div id="TabTop1" class="tab-pane active">
        <section>
            <div class="page-header">
                <h3><i class="fontello-icon-folder-2 opaci35"></i>Show <small>Products</small> in @if($dept_id)  {{ Category::where('id', $dept_id)->first()->title; }} @endif Department</h3>
            </div>
            <div class="row-fluid">
                <div class="span12">
