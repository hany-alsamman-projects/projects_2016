...
class Breadcrumbs extends DaveJamesMiller\Breadcrumbs\Facade{
	 ...
	 * @static 
	 */
	 public static function __construct($environment){
		 DaveJamesMiller\Breadcrumbs\Manager::__construct($environment);
	 }
	 ...
	 * @static 
	 */
	 public static function generateArray($name, $args = array()){
		 DaveJamesMiller\Breadcrumbs\Manager::generateArray($name, $args);
	 }
	 ...
	 * @static 
	 */
	 public static function renderArray($name, $args = array()){
		 DaveJamesMiller\Breadcrumbs\Manager::renderArray($name, $args);
	 }

}

class OAuth extends Thomaswelton\LaravelOauth\Facades\OAuth{
	/**
	 ...
	 */
	 public static function authorize($provider){
		return Thomaswelton\LaravelOauth\OAuth::authorize($provider);
	 }
	 ...
	 */
	 public static function login($provider){
		 Thomaswelton\LaravelOauth\OAuth::login($provider);
	 }
	 ...
	 * @static 
	 */
	 public static function associate($provider){
		 Thomaswelton\LaravelOauth\OAuth::associate($provider);
	 }
	 ...
	 * @static 
	 */
	 public static function token($provider){
		return Thomaswelton\LaravelOauth\OAuth::token($provider);
	 }
	 ...
	 * @static 
	 */
	 public static function hasToken($provider){
		 Thomaswelton\LaravelOauth\OAuth::hasToken($provider);
	 }
	 ...
	 */
	 public static function user($provider){
		 Thomaswelton\LaravelOauth\OAuth::user($provider);
	 }
	 ...
	 * @static 
	 */
	 public static function getAuthorizationUri($service, $scope, $state = array()){
		 Thomaswelton\LaravelOauth\OAuth::getAuthorizationUri($service, $scope, $state);
	 }
	 ...
	 * @static 
	 */
	 public static function getServiceFactory($service, $scope = null){
		 Thomaswelton\LaravelOauth\OAuth::getServiceFactory($service, $scope);
	 }
	 ...
	 * @static 
	 */
	 public static function getCredentials($service){
		 Thomaswelton\LaravelOauth\OAuth::getCredentials($service);
	 }
	 ...
	 * @static 
	 */
	 public static function getScopes($service){
		 Thomaswelton\LaravelOauth\OAuth::getScopes($service);
	 }
	 ...
	 */
	 public static function getStorage(){
		 Thomaswelton\LaravelOauth\OAuth::getStorage();
	 }
	 ...
	 */
	 public static function serviceExists($service){
		 Thomaswelton\LaravelOauth\OAuth::serviceExists($service);
	 }
	 ...
	 * @static 
	 */
	 public static function isOAuth2($service){
		 Thomaswelton\LaravelOauth\OAuth::isOAuth2($service);
	 }
	 ...
	 * @static 
	 */
	 public static function isOAuth1($service){
		 Thomaswelton\LaravelOauth\OAuth::isOAuth1($service);
	 }
	 ...
	 */
	 public static function encodeState($state){
		 Thomaswelton\LaravelOauth\OAuth::encodeState($state);
	 }
	 ...
	 */
	 public static function decodeState($state){
		 Thomaswelton\LaravelOauth\OAuth::decodeState($state);
	 }
	 ...
	 * @static 
	 */
	 public static function getState($provider){
		 Thomaswelton\LaravelOauth\OAuth::getState($provider);
	 }
	 ...
	 * @static 
	 */
	 public static function setOAuth1State($requestToken, $state){
		 Thomaswelton\LaravelOauth\OAuth::setOAuth1State($requestToken, $state);
	 }
	 ...
	 * @static 
	 */
	 public static function getOAuth1State($requestToken){
		 Thomaswelton\LaravelOauth\OAuth::getOAuth1State($requestToken);
	 }
	 ...
	 * @static 
	 */
	 public static function getStorageNamespace($service){
		 Thomaswelton\LaravelOauth\OAuth::getStorageNamespace($service);
	 }
	 ...
	 * @static 
	 */
	 public static function requestAccessToken($provider){
		 Thomaswelton\LaravelOauth\OAuth::requestAccessToken($provider);
	 }
	 ...
	 */
	 public static function setHttpClient($httpClient){
		//Method inherited from OAuth\ServiceFactory
		return Thomaswelton\LaravelOauth\OAuth::setHttpClient($httpClient);
	 }
	 ...
	 * @static 
	 */
	 public static function registerService($serviceName, $className){
		//Method inherited from OAuth\ServiceFactory
		return Thomaswelton\LaravelOauth\OAuth::registerService($serviceName, $className);
	 }
	 ...
	 * @static 
	 */
	 public static function createService($serviceName, $credentials, $storage, $scopes = array(), $baseApiUri = null){
		//Method inherited from OAuth\ServiceFactory
		return Thomaswelton\LaravelOauth\OAuth::createService($serviceName, $credentials, $storage, $scopes, $baseApiUri);
	 }
...
class GarbageCollect extends Gregwar\Image\GarbageCollect{
}
