...
.ocat_bg{
    width:100%;
    height:703px;
    background: url('image/cat_bg.jpg') top center no-repeat; 
}
...
.event_bg{
    width:100%;
    height:77px;
    background: url('image/events_bg.jpg') no-repeat;
    float:left;
    clear:both;
}
...
<?php if (count($currencies) > 1) { ?>
    ...
    <a href="<?php echo $wishlist; ?>" id="wishlist_total"><?php echo $text_wishlist; ?></a><a href="<?php echo $account; ?>"><?php echo $text_account; ?></a><a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></div>
      ...
      <?php } ?>
      	...
      	<div id="nav">
      		<ul>
    			...
    			<img class="slideit" height="64" src="image/nav/btn1.gif" /></a></li>
      			<li><a href="hany">
    			<img height="64" src="image/nav/btn2.gif" /></a></li>
    			<li><a href="index.php?route=information/contact">
    			<img height="64" src="image/nav/btn3.gif" /></a></li>
    			<li><a href="#">
    			<img height="64" src="image/nav/btn4.gif"/></a></li>
    			<li><a href="#">
    			<img height="64" src="image/nav/btn5.gif" /></a></li>
     		</ul>
      	</div>
