...
<div class="container">
<div id="carouse-cover">
  <div class=" jcarousel-skin-opencart"><div style="position: relative; display: block;" class="jcarousel-container jcarousel-container-horizontal"><div style="position: relative;" class="jcarousel-clip jcarousel-clip-horizontal"><ul style="overflow: hidden; position: relative; top: 0px; margin: 0px; padding: 0px; left: 0px; width: 276px;" class="jcarousel-list jcarousel-list-horizontal">


<?

    foreach($mybar as $rows){
        
        $image = $this->model_tool_image->resize($rows['image'], 100, 100);
//        $popupimage = $this->model_tool_image->resize($rows['image'], 230, 200);
//        
//        echo '
//        <div class="probar" id="bar'.$rows['product_id'].'">
//            <h3 style="padding:5px">SP '.$rows['price'].'</h3>
//            <img style="opacity: 0.6;" src="'.$popupimage.'" alt="test" title="test">
//            
//            <div class="cart">
//            Quantity
//          <input type="text" name="quantity" size="2" value="1" />            
//<a onclick="addToCart(\''.$rows['product_id'].'\');" class="button"><span>BUY</span></a>
//            </div>
//            
//        </div>';
        
        echo '<li jcarouselindex="1" style="float: left; list-style: none outside none; width: 166px;" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal">
            <a id="'.$rows['product_id'].'" href="index.php?route=product/product&path='.$_GET['path'].'&product_id='.$rows['product_id'].'"><img style="opacity: 0.6;" src="'.$image.'"></a>
        </li>';
...
<link rel="stylesheet" type="text/css" href="catalog/view/theme/shopcart/js/jquery.qtip.min.css" />
<script type="text/javascript" src="catalog/view/theme/shopcart/js/jquery.qtip.min.js"></script>

<link rel="stylesheet" type="text/css" href="catalog/view/theme/shopcart/stylesheet/carousel.css" media="screen">
...
{               
            ...
            $('.jcarousel-list a.toolTip').live('mouseover', function(event) {
            	// Bind the qTip within the event handler
            	$(this).qtip({
            		overwrite: false, // Make sure the tooltip won't be overridden once created
            		content: $('#bar' + this.id),
                    //content: { url: 'PageView.aspx?Param=' + this.id },
                	position: {
...
<a onclick="addToCart(\''.$rows['product_id'].'\');" class="button"><span>BUY</span></a>
        ...
        echo '<li jcarouselindex="1" style="float: left; list-style: none outside none; width: 166px;" class="jcarousel-item jcarousel-item-horizontal jcarousel-item-1 jcarousel-item-1-horizontal">
            <a class="toolTip" id="'.$rows['product_id'].'" href="#"><img style="opacity: 0.6;" src="'.$image.'" alt="test" title="test"></a>
        </li>';
