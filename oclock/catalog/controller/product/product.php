...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
            ...
            $catid = substr(strstr($this->request->get['path'],'_'), 1);
            $this->data['this'] = &$this;  
            
            // if($catid == '60' || $catid == '61'){             

                $mybar = $this->model_catalog_product->getBarOfProduct( $catid );              
                $this->data['mybar'] = $mybar;              
            //}
            
            $probar = $this->model_catalog_product->getBarOfProduct( 60 );       
