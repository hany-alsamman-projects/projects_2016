...
<td width="100%" colspan="2" style="vertical-align:top; text-align:left; padding-top:10px">
    ...
    <li><a target="_self" href="javascript:collapse2.slideit()"><img align="absbottom" src="../images/admin/mange.png"> 
	Management Pages</a></li><br />
    <div id="pages" style="margin-left: 10px">
    <a href="index.php?section=ViewPages" target="_self"><img align="absbottom" src="../images/admin/views.png"> 
		View Pages</a><br />
    <a href="index.php?section=AddPages" target="_self"><img align="absbottom" src="../images/admin/add.png"> 
		Add Pages</a><br />    
    </div>
	...
	<script type="text/javascript">
	var collapse2=new animatedcollapse("pages", 500, false, "block")
	</script>
	
    <li><a target="_self" href="javascript:collapseban.slideit()"><img align="absbottom" src="../images/admin/mange.png"/> 
	Management Banners</a></li><br />
    
	<div id="banners" style="margin-left: 10px">
	<a href="index.php?section=AddBanner" target="_self"><img align="absbottom" src="../images/admin/user_add.png" /> 
		Add Banner</a><br />
	<a href="index.php?section=ShowBanners" target="_self"><img align="absbottom" src="../images/admin/views.png"/> 
		Show Banners</a><br />
	</div>
	...
	<script type="text/javascript">
	var collapseban=new animatedcollapse("banners", 500, false, "block");
	</script>
