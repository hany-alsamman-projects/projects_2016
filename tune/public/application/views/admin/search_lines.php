<div id="nav_links">	
	<div> &rsaquo;&rsaquo; Home &rsaquo;&rsaquo;&nbsp; <b>Search result</b></div>
</div>
	...
	<table cellpadding="3" cellspacing="0" style="width: 100%; margin-bottom:10px">
		<tr>
			...
			<div>
			<a href="#" onmouseover="showtrail('../images/admin/tumble/<?=$row->t_pic?>','',250,150)" onmouseout="hidetrail();">
			PEVIEW PICTURE
			</a>
			</div>
		...
		<tr>
			...
			<td style="height: 20px; width: 75px"><a href="index.php?section=ShowObjects&SORT=top_views&active=dashboard">VIEWS (<?=$row->views?>)</a></td>
