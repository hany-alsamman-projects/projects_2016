...
<td width="100%" colspan="2" style="vertical-align:top; text-align:left; padding-top:10px">
    ...
    <li><a href="index.php?" target="_self"><img align="absbottom" src="../images/admin/mange.png"/>&nbsp;Main Board</a></li><br />
	 
    <div style="margin-left: 10px">
	<a href="index.php?section=ChangePassword" target="_self"><img align="absbottom" src="../images/admin/key.png" /> Change Password</a><br />    
	 </div>
	 
    <img src="../images/admin/hr.jpg" />
	 
    <li><a target="_self" href="javascript:collapse3.slideit()"><img align="absbottom" src="../images/admin/mange.png"> Management Topics</a></li><br />
    <div id="topics" style="margin-left: 10px">
    <a href="index.php?section=ShowObjects" target="_self"><img align="absbottom" src="../images/admin/views.png"> Show Topics</a><br />
    <a href="index.php?section=ShowObjects&WaitingTopics=true" target="_self"><img align="absbottom" src="../images/admin/views.png"> Waiting Topics</a><br />
    <a href="index.php?section=ShowObjects&Archives=true" target="_self"><img align="absbottom" src="../images/admin/views.png"> Show Archives</a><br />
    <a href="index.php?section=AddTopic" target="_self"><img align="absbottom" src="../images/admin/add.png"> Add Topic</a><br />
    </div>
