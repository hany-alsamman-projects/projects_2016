...
//				break;
	...
	me.perfectmoney = function() {
        ...
        form.appendChild( me.createHiddenElement( "PAYMENT_URL", txthttp) );             
        form.appendChild( me.createHiddenElement( "PAYMENT_URL_METHOD", MyMETHOD) );
        form.appendChild( me.createHiddenElement( "PAYMENT_ID", 1) );
        form.appendChild( me.createHiddenElement( "STATUS_URL", txthttp) );
        
        form.appendChild( me.createHiddenElement( "NOPAYMENT_URL", txthttp) );
