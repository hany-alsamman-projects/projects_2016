<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = $_SERVER["DOCUMENT_ROOT"].'/public/files/img/upload-files/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"].'/public/files/img/upload-files/'; // absolute or relative from this script path, required.
