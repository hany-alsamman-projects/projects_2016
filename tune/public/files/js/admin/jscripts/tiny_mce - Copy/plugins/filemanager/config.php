<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = $_SERVER["DOCUMENT_ROOT"].'/public/files/img/upload-files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"].'/public/files/img/upload-files/'; // absolute or relative from this script path.
