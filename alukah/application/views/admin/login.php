...
<div id="container">
    ...
    <form method="post" action="index.php" id="form-login">
        <ul class="inputs black-input large">
            ...
            <li><span class="icon-user mid-margin-left"></span><input type="text" name="username" id="login" value="" class="input-unstyled" placeholder="Login" autocomplete="off"></li>
            <li><span class="icon-lock mid-margin-left"></span><input type="password" name="password" id="pass" value="" class="input-unstyled" placeholder="Password" autocomplete="off"></li>
        </ul>
...
notify('اهلا بك', 'يمكنك تسجيل الدخول للبدء بإدارة حسابك مباشرة', {
    autoClose: false,
    hPos: 'right',
    delay: 2500,
