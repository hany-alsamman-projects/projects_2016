...
class Plugin_Contact extends Plugin {
	...
	public function form()
	{
		...
		$output	 = form_open_multipart($action, 'class="contact-form" id="register-form" novalidate="novalidate"').PHP_EOL;
		...
		$output .= '<span class="submit">'.form_submit('contact-submit', ucfirst($button)).'</span>'.PHP_EOL;
		$output .= form_close();
