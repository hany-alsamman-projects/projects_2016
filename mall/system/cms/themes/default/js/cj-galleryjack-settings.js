...
function galleryJackSettings() {
	...
	videoSettings = {
		...
		videoFallbackSwf: "system/cms/themes/default/img/flash/gallery_video.swf"
	...
	musicSettings = {
		...
		songList: [
			...
			{title: "Fawars Mall - Rock the Show", url: "system/cms/themes/default/img/music/song3.mp3"},
			{title: "Fawars Mall - Follow Me", url: "system/cms/themes/default/img/music/song2.mp3"},
			
			/* Last item doesn't have a comma at the end */
			{title: "Fawars Mall - U Let Me Down Again", url: "system/cms/themes/default/img/music/song1.mp3"}
	...
	socialSettings = {
		...
		facebookLike: "<div id='cj-facebook'><iframe src='http://www.facebook.com/plugins/like.php?locale=en_US&href=http://www.fawaresmall.com/&layout=button_count&show_faces=false&width=500&action=like&font&colorscheme=light&height=23' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:85px; height:23px;' allowTransparency='true'></iframe></div>",
		...
		/* Set this to an empty string to not use */
		twitterIcon: "<div id='cj-twitter-icon'><a href='http://twitter.com/{twitterUser}' target='_blank'><img src='system/cms/themes/default/img/cj_gallery/graphics/twitter.png' width='20' height='20' /></a></div>",
				
		/* Set this to an empty string to not use */
		facebookIcon: "<div id='cj-facebook-icon'><a href='http://www.facebook.com/{facebookUser}' target='_blank'><img src='system/cms/themes/default/img/cj_gallery/graphics/facebook.png' width='20' height='20' /></a></div>",
	...
	ajaxSettings = {
		...
		imagePath: "system/cms/themes/default/img/cj_gallery/photos/",
		...
		ajaxPhpUrl: "system/cms/themes/default/php/cj-ajax.php"
