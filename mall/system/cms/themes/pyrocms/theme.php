...
class Theme_PyroCMS extends Theme {
    ...
    public $name			= 'VIP CMS - Admin Theme';
    public $author			= 'VIPIT Development Team';
    public $author_website	= 'http://vip4it.com/';
    public $website			= 'http://vip4it.com/';
    public $description		= 'vip4it admin theme. HTML5 and CSS3 styling.';
    public $version			= '1.0';
	public $type			= 'admin';
