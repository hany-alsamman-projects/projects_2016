        ...
        if (!isset($_GET['task'])) {
            ...
            if ($_REQUEST['task'] == 'api'):
                ...
                ##if($this->APIuserID == 'obaid' && $this->APIkeyID == 'vip4ayman'){
                    ...
                    if($_REQUEST['do'] == 'trash_place') PLACES::TRASH_PLACE();
                    ...
                    if($_REQUEST['action'] ==  'user') {
                        ...
                        if($_REQUEST['do'] == 'support_user') echo NOTIFICATIONS::SUPPORT_USER();

			            if($_REQUEST['do'] == 'forget_pass') echo API::FORGET_PASSWORD();

                        if($_REQUEST['do'] == 'reset_pass') echo API::RESET_PASSWORD();
