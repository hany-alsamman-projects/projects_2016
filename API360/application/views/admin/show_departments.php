...
$result = mysql_query("SELECT * FROM `departments` where d_type='{$_GET[show]}' ORDER BY id DESC") or parent::_debug(mysql_error(),__CLASS__,"MYSQL ERROR ON LINE ". __LINE__);
