...
<script>
    var latLng = new google.maps.LatLng(23.885838,45.527344);
    var config = {
        zoom: 5,
        center: latLng,
					...
					<div class="boxin">
                        ...
                        <form class="fields" id="addplace" action="<?= $_SERVER['REQUEST_URI']?>" method="post"><!-- Forms (plain layout, cleaner) -->
							<fieldset class="last">
								...
								<input class="txt" name="place_name" style="width: 250px" type="text">
								<small></small>
                                ...
                                <input class="txt" id="map-lat" name="latitude" style="width: 250px" type="text">
                                <small></small>

                                <label for="some21">Longitude:</label>
                                <input class="txt" id="map-lng" name="longitude" style="width: 250px" type="text">
                                <small></small>

                                <label for="some21">Place address:</label>
                                <input class="txt" id="map-address" name="tour_address" style="width: 250px" type="text">
                                <small></small>

                                <label for="some21">Place Number:</label>
                                <input class="txt" name="place_number" style="width: 250px" type="text">
                                <small></small>

                                <label for="some21">Place Information:</label>
                                <input class="txt" name="place_info" style="width: 250px" type="text">
                                <small></small>
                                ...
                                <div class="sep">
                                    <label class="radio"><input class="radio" name="campaign_place" value="1" type="radio">campaign place</label>
                                    <label class="radio"><input class="radio" name="campaign_place" value="0" type="radio" checked>normal place</label>
                                </div>
                                <small>Select the type for this place</small>

                                <label for="some21">Activate Status:</label>
                                    <label class="radio"><input class="radio" name="approved" value="1" type="radio">enable</label>
                                    <label class="radio"><input class="radio" name="approved" value="0" type="radio" checked>disable</label><br>
