<div id="box1" class="box box-75"><!-- box full-width -->
    <div class="boxin">
        <div class="header">
            <h3>Show Virtual Tour Requests</h3>
        </div>
        <div id="box1-tabular" class="content"><!-- content box 1 for tab switching -->
            <fieldset>
                <table cellspacing="0">
                    ...
                    $result = mysql_query("SELECT * FROM `tour_requests` where `approved` != '1' ORDER BY first_name ASC") or parent::_debug(mysql_error(),__CLASS__,"MYSQL ERROR ON LINE ". __LINE__);
                    ...
                    while($row = mysql_fetch_object($result)){
                        ...
                        print <<<EOF
                                            ...
                                            <tr $class>
												<td class="tc first">$account_owner</td>
