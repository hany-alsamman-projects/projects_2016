<div class="box box-50 altbox">
					<div class="boxin">
						<div class="header">
							<h3>Edit Category (<? print $d_name_en ?>)</h3>
						</div>
							...
							<fieldset class="last">
                                ...
                                if($ok == 1){                             
                                    print '<div class="msg msg-ok">
                                            <p>The selected category was <strong>edited</strong> successfully !</p>
                                            </div>';
