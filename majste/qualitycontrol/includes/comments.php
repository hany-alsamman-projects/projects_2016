	...
	<li <?php comment_class( 'ticket' . ( $i % 2 ? '' : ' alt' ) ); ?> id="comment-<?php comment_ID(); ?>">
		...
		<div class="ticket-info">
			...
			<p class="ticket-author">
				...
				<small><?php printf( __( 'about <em title="%s">%s</em> ago', APP_TD ), esc_attr( get_the_date() . __( ' at ', APP_TD ) . get_the_time() ), esc_attr( human_time_diff( get_comment_time( 'U' ), current_time( 'timestamp' ) ) ) ); ?></small>
			</p>
