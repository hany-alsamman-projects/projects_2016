...
$(function() {
  ...
  $('.visible-desktop #messages, .visible-desktop #notifications_new, .visible-desktop #notifications_closed').click(function(e){
    e.preventDefault();
  });

    var status_new = home_url('status/new/');
    var status_closed = home_url('status/closed/');

    // header menu notifications
    $('.top-menu #notifications_new').popover({
      html:true,
      placement: 'bottom',
      title: 'مراسلات مفتوحة',
      content:'<ul><li><a href="'+status_new+'"><span></span><h4>يمكنك استعراض كل المراسلات</h4>هنا سوف تعرض المراسلات التي مازالت مفتوحة.</a></li></ul><div class="popover_footer"><a href="'+status_new+'">عرض كل المراسلات الجديدة</a></div>'
    });

    // header menu notifications
    $('.top-menu #notifications_closed').popover({
        html:true,
        placement: 'bottom',
        title: 'مراسلات مغلقة',
        content:'<ul><li><a href="'+status_closed+'"><span></span><h4>يمكنك استعراض كل المراسلات</h4>هنا سوف تعرض المراسلات التي تم اغلاقها</a></li></ul><div class="popover_footer"><a href="'+status_closed+'">عرض كل المراسلات المغلقة</a></div>'
    });
