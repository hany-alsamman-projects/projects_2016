...
class QC_Tickets {
	...
	function custom_post_types() {
		...
		$ticket_labels = array(
			'name'               => __( 'المراسلات', APP_TD ),
			'singular_name'      => __( 'مراسلة', APP_TD ),
			'add_new'            => __( 'اضافة جديد', APP_TD ),
			'add_new_item'       => __( 'اضافة مراسلة جديدة', APP_TD ),
			'edit_item'          => __( 'تعديل مراسلة', APP_TD ),
			'new_item'           => __( 'مراسلة جديدة', APP_TD ),
			'view'               => __( 'عرض المراسلة', APP_TD ),
			'view_item'          => __( 'عرض المراسلة', APP_TD ),
			'search_items'       => __( 'بحث في المراسلات', APP_TD ),
			'not_found'          => __( 'لا يوجد مراسلات جديدة', APP_TD ),
			'not_found_in_trash' => __( 'لا توجد مراسلات في سلة المحذوفات', APP_TD )
		);
	 ...
	 * TODO: ADD EMAIL NOTIFY WHEN ADD NEW TICKET FOR ticket_assign
	 * @since Codex Corp 0.1
	 */
	function add_ticket() {
