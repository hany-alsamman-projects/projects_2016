<header>
    <h1 id="logo"><a href="./" class="notext">ماجستي</a></h1>
    ...
    <div style="width: 90%; font-size: 10pt; direction: rtl; position: absolute; text-align: right; bottom: 70px; right: 0">
        ...
        <h5 style="direction: rtl">اهلا بك في ماجستي انت الآن مع :</h5>
    ...
    <nav>
        ...
        <ul class="socials">
            <li class="facebook"><a href="http://www.facebook.com/Majestenew">Facebook</a></li>
            <li class="twitter"><a href="https://twitter.com/majestemedia">Twitter</a></li>
        </ul>
    </nav>
</header>
