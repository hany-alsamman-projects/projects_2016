...
<label><input name="cpm_permission_newtopic[]"  type="checkbox" value="super_visor" <?php echo in_array('super_visor', $cpm_permission_newtopic) ? 'checked="checked"' : ''  ; ?> /> <?php _e('Super Visor', 'cubepm'); ?></label>
