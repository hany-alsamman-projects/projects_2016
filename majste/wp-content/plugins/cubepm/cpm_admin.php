...
function cpm_admin() {
	...
	add_submenu_page('cpm_admin_settings', 'Codex PM - ' .__('Settings','cp'), __('Settings','cp'), 'manage_options', 'cpm_admin_settings', 'cpm_admin_settings');
	add_submenu_page('cpm_admin_settings', 'Codex PM - ' .__('Setup','cp'), __('Setup','cp'), 'manage_options', 'cpm_admin_setup', 'cpm_admin_setup');
}
