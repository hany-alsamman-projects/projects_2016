...
if ( ! class_exists( 'Bit51' ) ) {
	...
	abstract class Bit51 {
		...
		function support() {
			...
			$content = __('If you need help getting this plugin or have found a bug <br> please visit the <a href="http://www.codexc.com/" target="_blank">by codex corp</a>.', $this->hook);
