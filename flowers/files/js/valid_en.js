$(document).ready(function(){
	...
	$('.container .active-text').animate({opacity:1, marginLeft: "250px"}, 12000);
...
function changeText(){
	...
	$nextText.css({opacity: 0}).addClass('active-text').animate({opacity:1, marginLeft: "250px"}, 12000, function(){
...
v_fields = new Array('sender_name','company_name','sender_email','sender_subject','sender_phone','sender_message');alert_on = true;thanks_on = true; thanks_message = "Thank you, Email has been sent !";	
