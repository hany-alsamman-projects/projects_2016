<?php
			...
			$result = mysql_query("SELECT * FROM `".$this->prefix_lang."_products` WHERE `in_dept` = '{$this->_ID}' and `extra` = '0' and `available` = '1' ORDER BY id DESC") or FUNCTIONS::_debug(mysql_error(),__CLASS__,"MYSQL ERROR ON LINE ". __LINE__);
			
			if(!mysql_num_rows($result)) echo '<div style="color: red; padding:15px">Sorry: this dept was empty !</div> '; 
