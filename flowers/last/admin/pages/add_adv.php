...
<div align="center"><? if ($add_status == 1) echo 'Êד ÇÖÇÝÉ ÇבÇÚבÇה ÈהÌÇÍ'; ?></div>
...
<table width="98%" cellpadding="5" cellspacing="0" class="style1">
	...
	<tr>
		<td width="49%">ד‗Çה ÇבÇÚבÇה</td>
		<td width="49%"><select name="banner_position" style="height: 22px">
		<option value="bottom">ÇÓÝב</option>
		<option value="left">ÇבםÓÇÑ</option>
		<option value="right">Çבםדםה</option>
		<option selected="" value="top">ÇבÃÚבל</option>
		</select>
		</td>
	</tr>
	<tr>
		<td width="50%">הזÚ ÇבÇÚבÇה</td>
		<td width="50%">
		<input type="radio" name="banner_type" value="image" checked> ÕזÑÉ 
		<br> 
		<input type="radio" name="banner_type" value="flash"> ÝבÇÔ
		</td>
	</tr>
	<tr>
		<td colspan="2" style="width: 100%; text-align:center"><input type="submit" value=" ÇÖÇÝÉ "></td>
	</tr>
	</table>
	...
	<div>דבÇÍÙÉ: ÚהÏ ÇÖÇÝÉ ÇÚבÇה ÌÏםÏ ÓזÝ Ê‗זה ÍÇבÊו ÛםÑ דÝÚבÉ </div>