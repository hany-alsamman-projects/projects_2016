...
<table align="center" cellpadding="5" cellspacing="0" style="width: 75%" class="white_bg board_style">
	...
	<tr>
		...
		<td style="width: 70%">
			<table class="gray_bg" align="right">
				<tr>
					<td style="text-align:right; width: 108px"><a href="index.php?section=ShowTopics">المواضيع</a> <img align="middle" src="images/admin/topic.png" /></td>
				</tr>
			</table>
		</td>
	</tr>
