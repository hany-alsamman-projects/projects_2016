...
<table align="center" width="95%" cellspacing="0" cellpadding="0" height="471">
	<tr>
		<td align="center" colspan="2"> ⁄œÌ· ’›Õ…</td>
	</tr>
	<tr>
		<td width="50%">«”„ «·’›Õ…</td>
	...
	<tr>
		...
		print $in_class;
		if($in_class == '1'){
		print '<option value="1" selected=true>«·ﬁ«∆„… «·—∆Ì”Ì…</option><option value="0">«·’›Õ« </option>';
		}else{
		print '<option value="1">«·ﬁ«∆„… «·—∆Ì”Ì…</option><option value="0" selected=true>«·’›Õ« </option>';
		}
		?>
		</select>
		</td>
	...
	<tr>
		<td colspan="2"><input type="submit" value=" ⁄œÌ·" name="submit"></td>
	</tr>
