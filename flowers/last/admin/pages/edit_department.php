...
<table align="center" border="1" width="95%" width="100%" cellspacing="0" cellpadding="0" height="208">
	...
	if($_GET['section'] == 'EditDepartment'){
	
	?>
	<tr>
		<td width="100%" colspan="2" height="269">
		<h5>уЭЪць Чсогу ШЧсслЩ ЧсХфЬсэвэЩ</h5>
		...
		$oFCKeditor->Value		= stripslashes($en_content_sub);
		$oFCKeditor->Create() ;
		?>
	...
	<tr>
		<td width="100%" colspan="2" height="269">
		<h5>уЭЪць Чсогу ШЧсслЩ ЧскбШэЩ</h5>
		<?php
		...
		$oFCKeditor->BasePath	= $sBasePath ;
		$oFCKeditor->Height	    = 500 ;
		$oFCKeditor->Value		= stripslashes($ar_content_sub);
		$oFCKeditor->Create() ;
		?>
		</td>
	</tr>
