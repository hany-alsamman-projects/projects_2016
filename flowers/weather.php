...
switch($weather_chile->city){
	...
	break;
	 ...
	 if($i == 0){
	 ?>
	 <div style="color:#0373bb; font-size:11pt; padding:8px">
	 <img align="left" src="images/weahter/<?=$weather_chile->fore_day1_imgcode?>.png" />	
	 <b><?=$city?></b></div>
	 <div style="color:#0373bb; font-size:9pt; padding:8px">วแอัวัษ วแยไ : <b><?=$weather_chile->fore_day1_thigh?></b> วฺแ์ / <b><?=$weather_chile->fore_day1_tlow?></b> วฯไ์ </div>
