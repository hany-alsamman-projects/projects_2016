...
class REVIEWS extends CONTROLLERS
{
    ...
    public function GET_REVIEW(){
        ...
        $result = @mysql_query("SELECT id as review_id, id as review_user, id as review_user_image , user_id as review_user_id , review_time_stamp, review_description, review_rating FROM `reviews` WHERE place_id = '{$place_id}'");
