...
var App = {
   ...
   init: function() {      
      ...
      $('.makeFlexslider:not(.flexslidered)').addClass("flexslidered").flexslider({
         animation: "slide",
         controlNav: false,
         itemWidth: 200,
         animationLoop: false,
   ...
   bindCustomEvents: function() {
      ...
      $(".home-trigger").click(function(e) {
         ...
         $(".main-nav-container").fadeIn(App.Config.animSpeed);
         $("footer").fadeOut();
      });
      ...
      if (false && (App.Util.mobile.detect() && App.Util.mobile.detect() == "android")) {
