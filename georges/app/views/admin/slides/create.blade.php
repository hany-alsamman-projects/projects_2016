            ...
            <div class="widget widget-simple">
                ...
                <div class="widget-content">
                    <div class="widget-body">
                        <form id="accounForm" class="form-horizontal" enctype="multipart/form-data" method="post" action="{{URL::to('admin/slides')}}">
                            <div class="row-fluid">
                                    ...
                                    <fieldset>
                                        ...
                                        <ul class="form-list label-left list-bordered dotted">
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="accountPrefix" class="span6" type="text" value="" name="description">
                                                </div>
                                            </li>
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input id="accountPrefix" class="span6" type="text" value="0" name="position">
                                                </div>
                                            </li>
                                            ...
                                            <li class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="well well-nice inline">
                                                        ...
                                                        <small>Dimensional recommended is 1350x650 .</small>
                                                    </div>
                                                </div>
                                            </li>
