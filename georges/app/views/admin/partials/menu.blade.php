...
<li class="accordion-group">
    <div class="accordion-heading"> <a href="#slides_menu" data-item="slides_menu"  data-parent="#mainSideMenu" data-toggle="collapse" class="accordion-toggle"> <span class="item-icon aweso-icon-list-alt"></span>
            Slides Management </a> </div>
    <ul class="accordion-content nav nav-list collapse" id="slides_menu">
        <li> <a href="{{URL::to('admin/slides')}}">Show Slides </a> </li>
        <li> <a href="{{URL::to('admin/slides/create')}}">Add Slide </a> </li>
    </ul>
</li>
