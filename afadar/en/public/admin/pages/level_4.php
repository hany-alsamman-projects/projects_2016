...
<script type="text/javascript">
        ...
        $('#upload_box2').hide();
            ...
            $('span#get_upload_box2').toggle(function() {
                      $('#upload_box2').fadeIn('slow', function() {
                        // Animation complete
                      });
            }, function() {
                      $('#upload_box2').fadeOut('slow', function() {
                        // Animation complete
                      });
            });
    	...
    	function ajaxFileUpload(myid)
    	{
    		...
    		(
    			{
    				url:'../library/doajaxfileupload.php',
    				secureuri:false,
    				fileElementId: myid,
    				dataType: 'json',
                            ...
                            <div id="shadow_top_false"></div>                            	
                                <div id="shadow_links_false">
                                    <ul>
                                        ...
                                        <li>
                                        <img align="absbottom" src="../images/admin/views.png"/><a href="index.php?section=AccountChart&active=members" target="_self">Show Chart</a>
                                        </li>
                                    </ul>                                
                                </div>
                            <div id="shadow_bottom_false"></div>                                                        
