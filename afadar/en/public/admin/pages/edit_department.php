...
<table align="center" border="1" width="95%" width="100%" cellspacing="0" cellpadding="0" height="208">
	...
	<tr>
		<td width="50%" height="38">Хгу Чсогу:</td>
	...
	<tr>
		...
		print '<input type="radio" name="d_active" value="1" >Ънкэс';		
		}
		
		if($stauts == 0){
		print '<input type="radio" name="d_active" value="0" checked>ЧэоЧн';
		}else{
		print '<input type="radio" name="d_active" value="0">ЧэоЧн';		
		}
		?>
		</td>
	</tr>
