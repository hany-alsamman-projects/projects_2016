...
<p class="nm-uploader-area">
	...
	<span><?php _e('اختر الملفات التي تريد رفعها على الموقع مباشرة , وبعد اتمام الرفع اضغط على الزر حفظ لاتمام رفعها بشكل كامل واخذ رابط الملف لترفقه مع الرسالة وبعد الرفع ستجد الملف في المرفوع قم بالضغط على اسمه باليمين ونسخ رابط الملف لترفعه ضمن رسالتك', 'nm_file_uploader_pro')?></span>
...
<ul class="nm-file-meta">
	<li class="caption">معلومات اضافية عن الملف</li>
    <li class="inputs">
    <ul class="desc">
      		<li>
...
<ul class="nm-file-meta">
	<li class="caption">&nbsp;</li>
    <li class="inputs">
    <input class="nm-submit-button" type="submit" value="<?php _e('حفظ', 'nm_file_uploader_pro')?>" name="nm-submit" id="nm-upload">
