					...
					<script type='text/javascript'> 
						jQuery(document).ready(function(){ 
							...
							jQuery('.add-field').click(function(){
								...
								var append = '<div class="field"><table><tbody><tr><th class="num">&nbsp;</th><th class="slug"><?php echo __( "Meta Key:", "extra_user_details" ); ?></th><th class="name"><?php echo __( "Field Name:", "extra_user_details" ); ?></th><th class="description"><?php echo __( "Description (Help Text):", "extra_user_details" ); ?></th><th class="userlevel"><?php echo __( "Access Level:", "extra_user_details" ); ?></th><th class="actions"></th></tr><tr><td>' + (jQuery('.sortcontainer div').size() + 1) + '.</td><td><input name="eud_fields['+ randnum +'][1]" type="text" value="" class="regular-text" size="" /></td><td><input name="eud_fields['+ randnum +'][0]" type="text" value="" class="regular-text" size="" /></td><td><input name="eud_fields['+ randnum +'][2]" type="text" value="" class="regular-text" size="80" /></td><td><select name="eud_fields['+ randnum +'][3]" style="width:100px"><option value="install_themes">Admins Only</option><option value="edit_others_posts">Admins, Editors</option><option value="publish_posts">Admins, Editors, Authors</option><option value="edit_posts">Admins, Editors, Authors, Contributors</option><option value="read" selected="selected">Everyone</option><option value="disable">Disable</option></select></td><td> <input type="button" value="Delete" class="delete-field button"></td></tr></tbody></table></div>';
