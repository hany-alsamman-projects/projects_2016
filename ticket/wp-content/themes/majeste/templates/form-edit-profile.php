...
<?php if (current_user_can('edit_published_posts')){ ?>
            <p id="sales-url">
               ...
               <!-- <a href="<?php echo home_url( '?page_id=5&sales=' . esc_attr( $user->user_login ) ); ?>"><?php echo home_url( '?page_id=5&sales=' . strtolower( $user->user_login ) ); ?></a> -->
	       <input name="sales-url" disabled=true type="text" value="<?php echo home_url( '?page_id=5&sales=' . strtolower( $user->user_login ) ); ?>" />
            </p>
<?php }?>
			<p id="user-display-name">
				<label for="display_name"><?php _e( 'اسم المستخدم:', APP_TD ); ?></label>
				<input name="display_name" disabled=true type="text" value="<?php echo esc_attr( $user->display_name ); ?>" />
			</p>
            ...
            <p id="user-phone">
                <label for="user-phone"><?php _e( 'واتس اب:', APP_TD ); ?></label>
                <input name="jabber" type="text" value="<?php echo esc_attr( $user->jabber ); ?>" />
            </p>
