...
(function($)
{
	...
	$.modal = function(options)
	{
		...
		{
			$('<ul class="action-tabs right"><li><a href="#" title="Close window"><img src="system/codexfw/assets/img/admin/icons/fugue/cross-circle.png" width="16" height="16"></a></li></ul>')
				.prependTo(win)
