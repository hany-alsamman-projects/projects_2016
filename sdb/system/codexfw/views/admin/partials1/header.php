<ul id="status-infos">
			...
			<li class="spaced"> <?php echo lang('cp_logged_in_welcome') ?> : <strong><?php echo $user->display_name ?></strong> <?php if ($this->settings->enable_profiles) echo ' | '.anchor('edit-profile', lang('cp_edit_profile_label')) ?></li>
<!--
			<li>
				<a href="#" class="button" title="5 messages"><img src="admin/icons/fugue/mail.png" width="16" height="16"> <strong>5</strong></a>
			...
			<li>
				<a href="#" class="button" title="25 comments"><img src="admin/icons/fugue/balloon.png" width="16" height="16"> <strong>25</strong></a>
...
-->
			<li><?php echo anchor('', lang('cp_view_frontend'), 'target="_blank"'); ?> | <?php echo anchor('admin/logout', lang('cp_logout_label')); ?></li>
		</ul>
