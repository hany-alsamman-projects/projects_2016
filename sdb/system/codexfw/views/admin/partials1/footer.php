<div id="footer-top">
	...
	<div class="float-left">
		...
		<p>
			<?php echo anchor('http://codexc.com/documentation', lang('cp_documentation')); ?> | 
			<?php echo anchor('http://github.com/philsturgeon/pyrocms/issues', lang('cp_report_bug')); ?> | 
			<?php echo anchor('http://codexc.com/contact', lang('cp_contact_support')); ?>
		</p>
	</div>
	
	<div class="float-right">
		<h2><a href="http://codexc.com/" target="_blank">PyroCMS</a> v<?php echo CMS_VERSION;?></h2>
	</div>
...
<div id="footer-bottom">
	...
	<p class="float-right">Copyright &copy; 2008 - <?php echo date('Y');?> <a href="http://philsturgeon.co.uk/" target="_blank">Hany alsamman</a></p>
