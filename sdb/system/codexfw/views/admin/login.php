...
<head>
	...
	<link href="system/codexfw/assets/css/admin/special-pages.css" rel="stylesheet" type="text/css">
	...
	<script type="text/javascript" src="system/codexfw/assets/js/admin/jquery-1.4.2.min.js"></script>
...
<!--[if lt IE 8]><div class="ie7"><![endif]-->
	...
	<section id="login-block">
		<div class="block-border"><div class="block-content">
			...
			?><form class="form with-margin" name="login-form" id="login-form" method="post" action="<?=base_url().'ajax/ajax_login'?>">
