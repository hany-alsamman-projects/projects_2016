...
*         @benedmunds
*
* Added Awesomeness: Hany alsamman
*
...
*/
	 ...
	 */
	$config['site_title']		   = "syriandramabook.com";

	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "info@syriandramabook.com";
	 ...
	 * id not required.
	 **/
	$config['columns']             = array('first_name', 'last_name', 'user_power','company', 'phone', 'lang', 'bio', 'dob', 'gender', 'phone', 'mobile', 'address_line1', 'address_line2', 'address_line3', 'postcode', 'website', 'msn_handle', 'aim_handle', 'yim_handle', 'gtalk_handle', 'gravatar', 'updated_on', 'display_name', 'twitter_access_token', 'twitter_access_token_secret');
