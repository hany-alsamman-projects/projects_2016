...
class Users extends Public_Controller {
	...
	public function view($id)
	{
        ...
        $get_options = array('group_id' => $id, 'active' => 1, 'user_power'=> 1);
       
		if ( ! $id or ! $users = $this->users_m->get_many_by($get_options))
		{
			redirect('drama-makers');
		}
        ...
        ->set_breadcrumb('عرض المجموعة', false)
...
//        $detector->face_detect($_SERVER["DOCUMENT_ROOT"].'/testcms/uploads/files/www.jpg');
//        $detector->toJpeg();
