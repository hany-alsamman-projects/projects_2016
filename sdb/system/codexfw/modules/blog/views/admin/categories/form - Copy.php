...
<div id="add-area-box" class="hidden">
	...
	<form class="crud">
		<ul>
			<li><label for="title"><?php echo lang('widgets.widget_area_title'); ?>
			</label>
				<?php echo form_input('title', NULL, 'class="new-area-title"'); ?>
				<span class="required-icon tooltip"><?php echo lang('required_label');?>
			</span></li>
			<li class="even"><label for="slug"><?php echo lang('widgets.widget_area_slug'); ?>
			</label>
		...
		<div class="float-right">
			<button type="submit"><span><?php echo lang('save_label'); ?></span>
			</button><button id="widget-area-cancel"><span><?php echo lang('cancel_label'); ?>
			</span></button></div>
	</form>
...
<div id="edit-area-box" class="hidden">
	...
	<form class="box-container crud">
		...
		<div class="float-right">
			<button type="submit"><span><?php echo lang('save_label'); ?></span>
			</button><button id="widget-edit-area-cancel"><span><?php echo lang('cancel_label'); ?>
			</span></button></div>
	</form>
	<div style="clear: both">
	</div>
...
<table>
	<tbody style="border-bottom: none">
		<tr>
			...
			<span class="widget-instructions float-right spacer-right"><?php echo lang('widgets.instructions')?>
			</span>
				...
				<?php if ($available_widgets): ?>
					...
					<?php foreach($available_widgets as $widget): ?>
						...
						<div class="widget-box-body">
							<p class="description"><?php echo $widget->description; ?>
							</p>
			...
			<!-- Widget Areas -->
			<td id="widget-areas" style="vertical-align: top;" valign="top" width="50%">
			<h2><?php echo lang('widgets.widget_area_wrapper'); ?></h2>
				...
				<section id="area-<?php echo $widget_area->slug; ?>">
					<header class="clearfix widget-area-header">
						<h3><a href="#"><?php echo $widget_area->title; ?></a>
					</h3>
					...
					<div class="widget-area-content accordion-content">
						<p class="tag"><?php echo sprintf('{%s:widgets:area slug="%s"}', config_item('tags_trigger'), $widget_area->slug);?>
						</p>
